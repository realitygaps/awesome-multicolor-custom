...
-- beautiful init
beautiful.init("~/.config/awesome/themes/custom-multicolor/theme.lua")
...
voldown = "amixer set Master 10%-"
volup = "amixer set Master 10%+"
...
-- {{{ Tags
tags = {
   names = { "web", "term", "chat", "media", "docs", "remote", "other" },
   layout = { layouts[1], layouts[3], layouts[4], layouts[1], layouts[5], layouts[1], layouts[3] }
}
...
globalkeys = awful.util.table.join(
     awful.key({ "Mod4", "Shift" }, "Left",  function () movetonexttag(-1) end),
     awful.key({ "Mod4", "Shift" }, "Right", function () movetonexttag( 1) end),
...
--        end),
    ...
    awful.key({ modkey,           }, "z", function () awful.util.spawn(physlock) end),
    awful.key({ modkey,           }, "q", function () awful.util.spawn(quassel) end),
    ...
    awful.key({ modkey, "Shift"   }, "r", function () awful.util.spawn(ranger) end),

    
    awful.key({}, "#167",  awful.tag.viewnext),
    awful.key({}, "#166",  awful.tag.viewprev),
    awful.key({}, "#123",  function () awful.util.spawn(volup) end),
    awful.key({}, "#122",  function () awful.util.spawn(voldown) end),
    awful.key({}, "#121",  function () awful.util.spawn(volmute) end),
    awful.key({}, "#121",  function () awful.util.spawn(volmute) end),
    awful.key({}, "#156",  function () awful.util.spawn(physlock) end),
